component accessors="true"{
	...
	//"static"
	property name="version" default="3.5.0-develop" setter="false";
	property name="osgiLibBundleVersion" default="5.2.3.0" setter="false"; //first 3 octets = POI version; increment 4th with other jar updates
