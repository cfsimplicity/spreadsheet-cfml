component accessors="true"{
	...
	//"static"
	property name="version" default="3.1.0-develop" setter="false";
	property name="osgiLibBundleVersion" default="5.1.0.1" setter="false"; //first 3 octets = POI version; increment 4th with other jar updates
	...
	public function init( struct dateFormats, string javaLoaderDotPath, boolean requiresJavaLoader ){
		...
		loadHelpers();
		getDateHelper().setFormats( arguments.dateFormats?:JavaCast( "Null", "" ) );
